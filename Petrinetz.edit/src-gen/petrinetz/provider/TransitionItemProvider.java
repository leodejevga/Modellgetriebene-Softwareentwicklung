...
public class TransitionItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addGewichtPropertyDescriptor(object);
	...
	protected void addBPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Transition_B_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Transition_B_feature",
								"_UI_Transition_type"),
						PetrinetzPackage.Literals.TRANSITION__B, true, false, true, null, null, null));
	}

	/**
	 * This adds a property descriptor for the Gewicht feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addGewichtPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Transition_Gewicht_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Transition_Gewicht_feature",
								"_UI_Transition_type"),
						PetrinetzPackage.Literals.TRANSITION__GEWICHT, true, false, false,
	...
	public ResourceLocator getResourceLocator() {
		return PetrinetzEditPlugin.INSTANCE;
	}
