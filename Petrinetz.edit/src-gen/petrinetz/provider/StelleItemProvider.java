...
/**
 * This is the item provider adapter for a {@link petrinetz.Stelle} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StelleItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	 ...
	 * @generated
	 */
	public StelleItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Stelle"));
	}
	...
	public String getText(Object object) {
		String label = ((Stelle) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_Stelle_type")
				: getString("_UI_Stelle_type") + " " + label;
	}
